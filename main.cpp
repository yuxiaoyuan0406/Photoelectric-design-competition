...
void slightlyAdjust()
{
    ...
    if (lightWidth > limitWidth)
    {
        speed[0] = -MIN_SPEED * 1.05;
        speed[1] = -speed[0];
        speed[2] = 0;
    }
    ...
    while (1)
    {
        ...
        {                                                     //stay in this loop
            ...
            if (isLightKilled == 0 && light == -1)
                findLight(0.1);
            else if (isLightKilled == 0 && lightNearby == 0 && lightWidth <= BREAK_WIDTH && lightHight <= 80 && lightHight > 60)
                farFieldAdjust();
